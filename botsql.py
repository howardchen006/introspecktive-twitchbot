...
class Bot(commands.Bot):
    def __init__(self):
        super().__init__(
            token='d9huccuu6zrad2i1uyr3tw909cam6i',  # Put oauth in
            client_id='pf7dnjevasaqpfq3d3v7414roa814z',  # Put client id in
            client_secret='epbiqsoaq9b2kcbzeiusq6dizmpc9e',  # Put client secret in
